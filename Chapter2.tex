...
\begin{matrix}
\displaystyle \epsilon^1 = \frac{q_{xx}-q_{yy}}{q_{xx}+q_{yy}} & ; & \displaystyle \epsilon^2 = \frac{2q_{xy}}{q_{xx}+q_{yy}}
\end{matrix}
\end{equation} 
%
...
\begin{matrix}
\displaystyle \epsilon^1 = \frac{(A^{-1}_{xx})^2-(A^{-1}_{yy})^2}{(A^{-1}_{xx})^2+(A^{-1}_{yy})^2+2(A^{-1}_{xy})^2} & ; & \displaystyle \epsilon^2 = \frac{2A^{-1}_{xy}(A^{-1}_{xx}+A^{-1}_{yy})}{(A^{-1}_{xx})^2+(A^{-1}_{yy})^2+2(A^{-1}_{xy})^2} &
\end{matrix}
\end{equation}
%
