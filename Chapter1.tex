...
In this Chapter we first treat the Universe as a homogeneous and isotropic system, following the guidelines of the Friedmann model \citep{Friedman1922}. We then study the physics of the large scale density fluctuations that are present on top of the uniform background. 
