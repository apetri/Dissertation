...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/spurious_visualize.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.75]{Figures/pdf/spurious_eb2D.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.6]{Figures/pdf/spurious_fit.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/sensors_visualize.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.6]{Figures/pdf/sensors_power.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.6]{Figures/pdf/lsst_galdistr.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/photoz_bias_Om-w.pdf}\includegraphics[scale=0.4]{Figures/pdf/photoz_constraints_Om-w_lensing_cmb.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.255]{Figures/pdf/bornBias_convergence_powerSN30_s0_nb100.pdf}
\includegraphics[scale=0.255]{Figures/pdf/bornBias_convergence_momentsSN15_s50_nb9.pdf}
\includegraphics[scale=0.255]{Figures/pdf/bornBias_convergence_momentsSN30_s50_nb9.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.6]{Figures/pdf/bornBias_ngal_convergence_powerSN_s0_nb100.pdf}
\end{center}
