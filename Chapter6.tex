...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/cfht_design.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/cfht_emulator_accuracy.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/cfht_pca_components.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.3]{Figures/pdf/cfht_robustness_pca_Omega_m-sigma8.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{Figures/pdf/cfht_contoursOmega_m-sigma8_single.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/pdf/cfht_contours_momentsOmega_m-sigma8.pdf} \includegraphics[scale=0.4]{Figures/pdf/cfht_contours_momentsOmega_m-sigma8smooth.pdf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{Figures/pdf/cfht_contoursSigma8Om055_single.pdf}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{Figures/pdf/cfht_contoursw-Sigma8Om055_single.pdf}
\end{center}
