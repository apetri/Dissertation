...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/png/cfht_design.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/png/cfht_emulator_accuracy.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/png/cfht_pca_components.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.3]{Figures/png/cfht_robustness_pca_Omega_m-sigma8.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{Figures/png/cfht_contoursOmega_m-sigma8_single.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/png/cfht_contours_momentsOmega_m-sigma8.png} \includegraphics[scale=0.4]{Figures/png/cfht_contours_momentsOmega_m-sigma8smooth.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{Figures/png/cfht_contoursw-Sigma8Om055_single.png}
\end{center}
