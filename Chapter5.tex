...
\end{center}
\caption{Sample 1,2 and 3$\sigma$ confidence contours on $(\Omega_m,\sigma_8)$. The gray scale refers to the value of the parameter likelihood $\mathcal{L}$}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.255]{Figures/eps/bornBias_convergence_power_s0_nb100.eps}
\includegraphics[scale=0.255]{Figures/eps/bornBias_convergence_moments_s0_nb9.eps}
\includegraphics[scale=0.255]{Figures/eps/bornBias_convergence_momentsSN_s0_nb9.eps}
\end{center}
